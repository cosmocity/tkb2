...
<body>
    <div class="container">
        ...
        <section class="container-fluid wide">
            <div class="row">
                <div class="col-xs-3">
                    <img src="{$img1.0}" class="img-full img-thumbnail">
                </div>
                <div class="col-xs-3">
        ...
        <form action="{$nextpage}" method="post">
            <div class="form-group">
                <label class="checkbox">
                    <input type="checkbox" data-toggle="checkbox" value="1" name="que1[1]">{$qt1.0}
                </label>
                <label class="checkbox">
                    <input type="checkbox" data-toggle="checkbox" value="1" name="que1[2]">{$qt1.1}
                </label>
                <label class="checkbox">
                    <input type="checkbox" data-toggle="checkbox" value="1" name="que1[3]">{$qt1.2}
                </label>
                <label class="checkbox">
                    <input type="checkbox" data-toggle="checkbox" value="1" name="que1[4]">{$qt1.3}
                </label>
                <p align="center">
